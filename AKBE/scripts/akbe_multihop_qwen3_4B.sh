...
EXPERIMENT_NAME="akbe_multihop_qwen3_4B_0520"
...
# Data file paths (multihop, dual_path for SDPO)
TRAIN_FILES="${PARENT_DIR}/../ARPO/rl_datasets/hotpotqa_dual_path/train_dual_path.parquet"
VALID_FILES=["${PARENT_DIR}/../ARPO/rl_datasets/multihop/test.parquet"]
